...
var (
	...
	orgCommunitiesPlatformIndex   = utils.NonEmptyEnv("USER_COMMUNITIES_PLATFORM_INDEX")
	namespace                     = utils.NonEmptyEnv("LOG_NAMESPACE")
	orgCommunitiesChannelIndex    = utils.NonEmptyEnv("USER_COMMUNITY_CHANNEL_INDEX")
	reportPostingLambda           = utils.NonEmptyEnv("FEEDBACK_REPORT_POSTING_LAMBDA_NAME")
	reportingLambda               = utils.NonEmptyEnv("FEEDBACK_REPORTING_LAMBDA_NAME")
	...
	coachingQuarterYearIndex      = utils.NonEmptyEnv("COACHING_RELATIONSHIPS_QUARTER_YEAR_INDEX")
	...
	strategyCommunitiesUserChannelIndex = utils.NonEmptyEnv("STRATEGY_COMMUNITIES_USER_CHANNEL_INDEX")
