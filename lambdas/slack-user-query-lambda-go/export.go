...
func RefreshCommunitiesForPlatform(l awsutils.LambdaRequest, slackLambdaName string, platformID models.PlatformID) {
	// Invoke a lambda that handles slack users
	clientReq := models.ClientPlatformRequest{PlatformID: platformID}
