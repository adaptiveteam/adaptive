...
func EditCapabilityCommunitySurveyElems(teamID models.TeamID, cc *strategy.CapabilityCommunity,
	conn common.DynamoDBConnection) []ebm.AttachmentActionTextElement {
