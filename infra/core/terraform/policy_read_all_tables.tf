...
data "aws_iam_policy_document" "read_all_tables" {
  ...
  statement {
    ...
    resources = [
      "${aws_dynamodb_table.accountability_partnership_rejections_table.arn}/index/*",
      ...
      "${aws_dynamodb_table.client_config_dynamodb_table.arn}/index/*",
      "${aws_dynamodb_table.coaching_rejections.arn}/index/*",
      ...
      "${aws_dynamodb_table.vision.arn}/index/*",
    ]
  }
}
