...
func (d SlackTeam) ParseUnsafe(js []byte, logger logger.AdaptiveLogger) interface{} {
...
func (d SlackTeam) HandleStreamEntityUnsafe(e2 model.StreamEntity, conn *gorm.DB, logger logger.AdaptiveLogger) {
