...
func ReadByHashKeyPlatformID(platformID common.PlatformID) func (conn common.DynamoDBConnection) (out []Migration, err error) {
	return func (conn common.DynamoDBConnection) (out []Migration, err error) {
		var instances []Migration
...
func ReadByHashKeyPlatformIDUnsafe(platformID common.PlatformID) func (conn common.DynamoDBConnection) (out []Migration) {
	return func (conn common.DynamoDBConnection) (out []Migration) {
		out, err2 := ReadByHashKeyPlatformID(platformID)(conn)
		core.ErrorHandler(err2, "daos/Migration", fmt.Sprintf("Could not query PlatformIDMigrationIDIndex on %s table\n", TableName(conn.ClientID)))
		return
	}
}
