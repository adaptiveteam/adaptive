...
func ReadByHashKeyID(id string) func (conn common.DynamoDBConnection) (out []CapabilityCommunity, err error) {
	return func (conn common.DynamoDBConnection) (out []CapabilityCommunity, err error) {
...
func ReadByHashKeyIDUnsafe(id string) func (conn common.DynamoDBConnection) (out []CapabilityCommunity) {
	return func (conn common.DynamoDBConnection) (out []CapabilityCommunity) {
		out, err2 := ReadByHashKeyID(id)(conn)
		core.ErrorHandler(err2, "daos/CapabilityCommunity", fmt.Sprintf("Could not query IDPlatformIDIndex on %s table\n", TableName(conn.ClientID)))
		return
	}
}
