...
func tearDown() {
	if testing.Short() {
		log.Println("Skipping terraform tearDown in short mode")
	} else {
...
var _ = BeforeSuite(func() {
	if testing.Short() {
		log.Println("Skipping terraform initialization in short mode")
	} else {
...
var _ = AfterSuite(func() {
	if testing.Short() {
		log.Println("Skipping terraform destroy in short mode")
	} else {
