...
func ReadByHashKeyUserID(userID string) func (conn common.DynamoDBConnection) (out []UserAttribute, err error) {
	return func (conn common.DynamoDBConnection) (out []UserAttribute, err error) {
		var instances []UserAttribute
...
func ReadByHashKeyUserIDUnsafe(userID string) func (conn common.DynamoDBConnection) (out []UserAttribute) {
	return func (conn common.DynamoDBConnection) (out []UserAttribute) {
		out, err2 := ReadByHashKeyUserID(userID)(conn)
		core.ErrorHandler(err2, "daos/UserAttribute", fmt.Sprintf("Could not query UserIDAttrKeyIndex on %s table\n", TableName(conn.ClientID)))
		return
	}
}
