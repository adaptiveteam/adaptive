...
func ReadByHashKeyID(id string) func (conn common.DynamoDBConnection) (out []UserObjectiveProgress, err error) {
	return func (conn common.DynamoDBConnection) (out []UserObjectiveProgress, err error) {
...
func ReadByHashKeyIDUnsafe(id string) func (conn common.DynamoDBConnection) (out []UserObjectiveProgress) {
	return func (conn common.DynamoDBConnection) (out []UserObjectiveProgress) {
		out, err2 := ReadByHashKeyID(id)(conn)
		core.ErrorHandler(err2, "daos/UserObjectiveProgress", fmt.Sprintf("Could not query IDCreatedOnIndex on %s table\n", TableName(conn.ClientID)))
		return
	}
}
